...
# def save_dicom(data, output_dir, metadata):
#     """
#     将数据保存为 DICOM 文件
#     """
...
#     # 创建一个参考 DICOM 文件
#     ref_ds = Dataset()
#     ref_ds.PixelSpacing = metadata['pixel_spacing']
#     ref_ds.SliceThickness = metadata['slice_thickness']
#     ref_ds.ImagePositionPatient = metadata['image_position']
#     ref_ds.ImageOrientationPatient = metadata['image_orientation']
#     ref_ds.Rows, ref_ds.Columns = data.shape[1], data.shape[2]
...
#         ds.ImagePositionPatient[2] = metadata['image_position'][2] + i * metadata['slice_thickness']
...
if '__main__' == __name__:
    dcm_dir = r'C:\Users\yan\Downloads\FD_1mm\full_1mm\L067\full_1mm'
    ...
    angle_step = 0.5 # 角度步长（度）
    angle=angle_range[1]-angle_range[0] # 选择要可视化的角度
    output_nii_path = os.path.join(output_dir, f'reconstruction_angle_{angle:.1f}_image')
